...
그리고 이 프로젝트는 풀스택으로 진행되었습니다. 안드로이드 개발자를 목표로 하고 있지만 전체 과정을 다 진행해본 사람과 안드로이드 하나만 해본 사람은 많은 차이가 있다고 생각합니다. 백엔드 코드는 매우 조잡하고 실제 사용할 수 없는 정도의 수준을 가지고 있습니다. 다만 이런 전체 과정을 진행해봄으로 애플리케이션이 어떻게 동작되고 어떻게 정보를 주고 받는지에 대해 알 수 있었습니다. 
