...
import com.example.mystorage.databinding.FragmentUserInform1Binding

class UserInformFragment1 : Fragment() {
    private lateinit var binding: FragmentUserInform1Binding
    private val handler = Handler()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentUserInform1Binding.inflate(inflater, container, false)
        return binding.root
    }
